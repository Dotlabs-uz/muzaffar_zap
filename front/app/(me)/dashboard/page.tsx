                            ...
                            <TableBody className='radius'>
                                {
                                    [0, 1, 2, 3, 4, 5, 6, 7].map((i: number) => (
                                        <TableRow key={i} className='border-none cursor-pointer'>
                                            <TableCell className="font-medium text-center rounded-l-lg">{i + 1}</TableCell>
                                            <TableCell className="font-medium">INV001</TableCell>
                                            <TableCell>Paid</TableCell>
                                            <TableCell>Credit Card</TableCell>
                                            <TableCell className="text-right rounded-r-lg">$250.00</TableCell>
                                        </TableRow>
                                    ))
                                }
                            </TableBody>
